...
yet wired into `service/data/sources.txt`. Mined from event links in Bay Area
culture newsletters:
- [Devon Youngblood's Substack](https://devonyoungblood.substack.com/) — arts + culture.
- [Same Page SF](https://samepagesf.substack.com/) — literary events (bookstores, readings, lit orgs).

Each still needs a spike to confirm scrapable structured data (JSON-LD / API /
ICS) before a scraper is written — see `CONTRIBUTING.md`. Many venues host
events on a shared ticketing platform (Eventbrite, Luma, Veezi, Posh, Square,
VBO, Tixr, Eventive) — the venue's own site is listed here as the source; a
platform scraper may be the better path for some (noted where relevant).
...
- **Minnesota Street Project** (gallery hub) — https://minnesotastreetproject.com/events
- **Creative Growth** (Oakland) — https://creativegrowth.org/
- **NIAD Art Center** (Richmond) — https://niadart.org/
- **FM Oakland** — https://fmoakland.com/
- **Jessica Silverman Gallery** — https://jessicasilvermangallery.com/
- **Fraenkel Gallery** — https://fraenkelgallery.com/exhibitions
- **Gallery Wendi Norris** — https://gallerywendinorris.com/exhibitions
- **Rebecca Camacho Presents** — https://rebeccacamacho.com/exhibitions
...
- **Jewish Film Institute / SFJFF** — https://jfi.org/
- **SF Dance Film Festival** — https://sfdancefilmfest.org/
...
- **SF Porchfest** — https://sfporchfest.org/
- **SF Electronic Music Festival** — https://www.sfemf.org/
- **SF International Arts Festival** — https://sfiaf.org/  *(VBO ticketing)*
- **San Francisco Art Fair** — https://sanfranciscoartfair.com/
- **The Superfair** — https://thesuperfair.com/
- **Butter Art Fair** (Black visual artists) — https://butterartfair.com/
...
- **Bay Area Queer Zine Fest** — https://bayareaqueerzinefest.com/
- **LaborFest** — https://laborfest.net/
...
- **afikra** (Arab arts/culture) — https://www.afikra.com/
- **Mazikaa Enterprise** (Arab music) — https://mazikaa-enterprise.square.site/
...
- **DoTheBay** — https://dothebay.com/ (Bay Area events aggregator)
